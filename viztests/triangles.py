...
def setup(scene):
    ...
    scene.add(ppb.RectangleSprite(
        width=0.5, height=1,
        image=ppb.Rectangle(ppb.Color(200, 0, 0), (1, 2)), position=(-2, 2)))
    scene.add(ppb.RectangleSprite(
        width=1, height=0.5,
    ...
    scene.add(ppb.RectangleSprite(
        width=1, height=0.5,
        image=ppb.Triangle(ppb.Color(0, 200, 100), (2, 1)), position=(0, 0)))
    scene.add(ppb.Sprite(image=ppb.Triangle(ppb.Color(50, 200, 150)), position=(2, 0)))
    scene.add(ppb.RectangleSprite(
        width=0.5, height=1,
        image=ppb.Ellipse(ppb.Color(0, 0, 200), (1, 2)), position=(-2, -2)))
    scene.add(ppb.RectangleSprite(
        width=1, height=0.5,
        image=ppb.Ellipse(ppb.Color(100, 0, 200), (2, 1)), position=(0, -2)))
    scene.add(ppb.Sprite(image=ppb.Circle(ppb.Color(150, 50, 200)), position=(2, -2)))
